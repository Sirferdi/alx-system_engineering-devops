...
NOTE: Compiling a magic source file: file -C -m .mgc. This produces the compiled magic files. file -i -m .mgc * This allows you to use the compiled file by specifying its name using the -m switch again.
